...
CONCERNS = ["recession fears", "inflation concerns", "supply chain issues", "geopolitical tensions"]
...
def generate_rv(base_rv=2.0, volatility=1.0, headline=None):
    ...
    if headline:
        ...
        high_vol_words = ["plunge", "surge", "crisis", "crash", "soar", "tumble", 
                          "spike", "record", "disappointing", "recession"]
...
def generate_dataset(n_samples=1000, start_date="2020-01-01", base_rv=2.0, volatility=1.0):
    """
...
def main():
    ...
    parser.add_argument('--output', type=str, default='data/headlines_rv.csv', help='Output CSV path')
    parser.add_argument('--start_date', type=str, default='2020-01-01', help='Start date (YYYY-MM-DD)')
    parser.add_argument('--base_rv', type=float, default=2.0, help='Base realized volatility')
    parser.add_argument('--volatility', type=float, default=1.0, help='Volatility of RV process')
